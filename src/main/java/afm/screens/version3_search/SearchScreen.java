...
public final class SearchScreen extends GridPane {
    ...
    @FXML private Button genreHelpBtn;
    @FXML private Text genreText;
    @FXML private ContextMenu genreContextMenu;
    
    @FXML private ComboBox<String> sznCombo;
    @FXML private ComboBox<Integer> yearCombo;
    @FXML private ContextMenu seasonContextMenu;
    @FXML private Text seasonText;
    
    @FXML private TextField minEpsField;
    ...
    @FXML void addGenre(ActionEvent event) {
    ...
    @FXML void addSeason(ActionEvent event) {
    ...
    @FXML void addAllYear(ActionEvent event) {
    	final Integer year = yearCombo.getValue();
    ...
    @FXML void openGenreInfoWindow(ActionEvent event) {
    	GenreInfoWindow.open(genreHelpBtn);
    }
    
    @FXML void clearGenres(ActionEvent event) {
    	genreCombo.setValue(null);
    	genreSet.clear();
    }

    @FXML void clearSeasons(ActionEvent event) {
    ...
    @FXML void startSearchProcess(ActionEvent event) {
