...
public class CustomScreen extends GridPane {
    ...
    @FXML private TextField currEpField;
    ...
    @FXML void resetFields(ActionEvent event) {
    	nameField.setText("");
    ...
    @FXML void tryAddToMyList(ActionEvent event) {
    	if (!canAdd()) return;
    ...
    @FXML void tryAddToToWatch(ActionEvent event) {
    	if (!canAdd()) return;
